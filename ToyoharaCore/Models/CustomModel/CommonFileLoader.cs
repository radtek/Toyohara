...
namespace ToyoharaCore.Models.CustomModel
{
    ...
    { public CommonFileLoader(int loading_type_id, string file_name, string summary, int user_id,
                              string stored_procedure_select, int columnCountSelect, int rowCountSelect, int ColumnCount, int RowCount,
       ...
       // public string description { get; set; }
        ...
        public string LoadFile() {
            ...
            var obj2 = new { loading_id = loading_id, error = error, allow_commit = loading_info.allow_commit, excelFileName = insertGuid,
        ...
        void ExceptionR(ExcelWorksheet ew ) {
            try
            {
                ...
                {
                    if (Convert.ToString(ew.Cells[RowCount, ColumnCount].Value) != Convert.ToString(ColumnCount))
                ...
                while(rowFlag){
                    ...
                    while (ColumnCount <= totalCount)
                    {
                        ...
                        {                           
                            ...
                            if (setting != null && Convert.ToBoolean(setting.is_visible) && Convert.ToBoolean(setting.global_visible))
                            {
                                try
