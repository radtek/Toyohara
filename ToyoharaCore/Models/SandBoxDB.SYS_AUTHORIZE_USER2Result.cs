...
{
    public partial class SYS_AUTHORIZE_USER2Result {

        public SYS_AUTHORIZE_USER2Result()
        {
            OnCreated();
        }
        ...
        public virtual string site_map
        {
            get;
            set;
        }

        public virtual string site_map_subcontractor
        {
            get;
            set;
        }

        public virtual int delegating_user_id
        {
            get;
            set;
        }

        public virtual string delegating_user_description
        {
            get;
            set;
        }

        public virtual int is_administrator
        {
            get;
            set;
        }

        public virtual System.Nullable<int> department_id
        {
            get;
            set;
        }

        public virtual string system_message
        {
            get;
            set;
        }
