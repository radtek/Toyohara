...
//        public Home3Controller(IHostingEnvironment env)
//        {
//            _env = env;
//        }
...
//            //ViewBag.FAQ = portalDMTOS.UI_SELECT_LINK_PAGE_NOTE(this.ToString(), "Index", au.delegating_user_id).FirstOrDefault().http_text;
...
//            HttpContext.Session.SetString("FAQ", JsonConvert.SerializeObject(portalDMTOS.UI_SELECT_LINK_PAGE_NOTE2(link_info.id, au.delegating_user_id, au.id).FirstOrDefault().http_text));
...
//        [HttpGet]
//        [AppAuthorizeAttribute]
//        public object Get(DataSourceLoadOptions loadOptions, string test, bool? showSelected, string selectedRecord, bool? only_new, bool? show_classified, bool rebind)
//        {
...
//            //var loadrResults = DataSourceLoader.Load(x, loadOptions);
...
//            //{
//            //    foreach (var a in loadOptions.Sort)
//            //    {
//            //        sort = sort + a.Selector;
//            //        if (a.Desc == true)
//            //            sort = sort + " desc,";
//            //        else
//            //            sort = sort + ",";
...
//            //string filters="";
//            //foreach (var a in loadOptions.Filter)
//            //{

//            //}
//            //  UI_SELECT_GRID_AUTO_SETTINGSResult x2 = portalDMTOS.PRC_SELECT_ORDER_ITEMS_GKI_with_paging(ref skip, loadOptions.Take, selectedRecord,sort, loadOptions.Filter, show_classified, only_new, au.delegating_user_id);
//            //loadOptions.RequireTotalCount = true;
//            //var d = DataSourceLoader.Load(x, loadOptions);
//            //d.totalCount = 200;
...
//            PortalDMTOSModel oSandBoxDBEntities = new PortalDMTOSModel();
//            // SYS_SELECT_DELEGATING_USERResult sdu = oSandBoxDBEntities.SYS_SELECT_DELEGATING_USER(au.id, id).FirstOrDefault();

//            if (true)//sdu != null)
//            {
//                //SYS_AUTHORIZE_USER2Result au2 = oSandBoxDBEntities.SYS_AUTHORIZE_USER2(sdu.login, sdu.id, "").FirstOrDefault();

//                //au.delegating_user_id = sdu.id;
//                //au.delegating_user_description = sdu.description;
//                // au.site_map = au2.site_map;
//                HttpContext.Session.SetString("SYS_AUTHORIZE_USER2_R", JsonConvert.SerializeObject(au));


//                List<SYS_SELECT_DELEGATING_USERSResult> sduc = oSandBoxDBEntities.SYS_SELECT_DELEGATING_USERS(au.id, au.delegating_user_id).ToList<SYS_SELECT_DELEGATING_USERSResult>();
