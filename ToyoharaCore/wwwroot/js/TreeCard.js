function InsertTreeCard(flowWindowName, gridId, bindning, close_window, storedProcedure, id_func, additionalParams) {
...
function OpenTreeCard(AddUpdateFlag, CardId, GridId, ParamStr) {
